...
class enrol_elediacohortgreeting_plugin extends enrol_plugin {
    ...
    public function get_newinstance_link($courseid) {
        ...
        return new moodle_url('/enrol/elediacohortgreeting/edit.php', array('courseid'=>$courseid));
    }
    ...
    public function cron() {
        ...
        enrol_elediacohortgreeting_sync();
    }
    ...
    public function update_status($instance, $newstatus) {
        ...
        require_once("$CFG->dirroot/enrol/elediacohortgreeting/locallib.php");
        enrol_elediacohortgreeting_sync($instance->courseid);
    }
    ...
    public function get_manual_enrol_button(course_enrolment_manager $manager) {
        ...
        $cohorturl = new moodle_url('/enrol/elediacohortgreeting/edit.php', array('courseid' => $course->id));
        $button = new enrol_user_button($cohorturl, get_string('enrolcohort', 'enrol_elediacohortgreeting'), 'get');
        $button->class .= ' enrol_elediacohortgreeting_plugin';
        ...
        $button->strings_for_js('cohort', 'enrol_elediacohortgreeting');
        ...
        $modules = array('moodle-enrol_elediacohortgreeting-quickenrolment', 'moodle-enrol_elediacohortgreeting-quickenrolment-skin');
        $function = 'M.enrol_elediacohortgreeting.quickenrolment.init';
        $arguments = array(
            'courseid'        => $course->id,
            'ajaxurl'         => '/enrol/elediacohortgreeting/ajax.php',
    ...
    public function restore_instance(restore_enrolments_structure_step $step, stdClass $data, $course, $oldid) {
        ...
        if ($data->roleid and $DB->record_exists('cohort', array('id'=>$data->customint1))) {
            ...
            require_once("$CFG->dirroot/enrol/elediacohortgreeting/locallib.php");
            enrol_elediacohortgreeting_sync($course->id, false);
