...
if ($options['help']) {
    $help =
        "Execute elediacohortgreeting course enrol sync.
...
Example:
\$ sudo -u www-data /usr/bin/php enrol/elediacohortgreeting/cli/sync.php
";
...
$result = enrol_elediacohortgreeting_sync($trace, null);
$trace->finished();
