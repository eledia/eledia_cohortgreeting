...
/**
 * Strings for component 'enrol_elediacohortgreeting', language 'en'
 *
 * @package    enrol
...
$string['elediacohortgreetingsearch'] = 'Search';
...
$string['instanceexists'] = 'elediacohortgreeting is already synchronised with selected role';
$string['memberscount'] = 'Cohort size';
$string['name'] = 'Name';
$string['nocomponent'] = 'Created manually';
$string['potusers'] = 'Potential users';
$string['potusersmatching'] = 'Potential matching users';
$string['pluginname'] = 'eLeDia cohort greeting sync';
$string['pluginname_desc'] = 'elediacohortgreeting enrolment plugin synchronises elediacohortgreeting members with course participants.';
