...
class enrol_cohort_lib_testcase extends advanced_testcase {
    ...
    public function test_enrol_elediacohortgreeting_create_new_group() {
        ...
        // Run the function.
        $groupid = enrol_elediacohortgreeting_create_new_group($course->id, $cohort->id);
        // Check the results.
        ...
        $groupid = enrol_elediacohortgreeting_create_new_group($course2->id, $cohort->id);
    ...
    public function test_get_user_enrolment_actions() {
        ...
        $pluginname = 'elediacohortgreeting';

        // Only enable the elediacohortgreeting enrol plugin.
        ...
        // Teachers don't have enrol/elediacohortgreeting:unenrol capability by default. Login as admin for simplicity.
        $this->setAdminUser();
